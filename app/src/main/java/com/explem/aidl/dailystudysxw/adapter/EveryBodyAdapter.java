...
public class EveryBodyAdapter extends BaseAdapter {
    private final Context context;
    private final List<Home_Fragment_main.DataBean.IndexothersBean> list;

    public EveryBodyAdapter(Context context , List<Home_Fragment_main.DataBean.IndexothersBean> list) {
